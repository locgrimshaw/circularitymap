    ...
    boundaryLayer = L.geoJSON(data, {
      ...
      onEachFeature: (feature, layer) => {
        layer.bindTooltip(feature.properties.name, {
          className: 'bg-white border border-black text-black px-2 py-1 text-[10px] font-bold uppercase tracking-widest rounded-none shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]',
